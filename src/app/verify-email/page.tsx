            ...
            <div className="px-8 py-10">
              ...
              <div className="bg-linear-to-br from-blue-50 to-cyan-50 rounded-xl p-6 mb-8 border border-cyan-100">
                ...
                <ol className="space-y-3 text-gray-700">
                  ...
                  <li className="flex items-start gap-3">
                    <span className="flex-shrink-0 w-6 h-6 bg-cyan-600 text-white rounded-full flex items-center justify-center text-sm font-semibold">
                      2
                    </span>
                    <span>Recherchez un email de <strong>LAU Alumni Platform</strong></span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="flex-shrink-0 w-6 h-6 bg-blue-900 text-white rounded-full flex items-center justify-center text-sm font-semibold">
                      3
                    </span>

          ...
          {filteredFormations.map((formation) => {
            ...
            return (
              <div 
                ...
                className="group bg-white rounded-2xl border border-gray-200 overflow-hidden hover:border-purple-300 hover:shadow-xl transition-all duration-300 cursor-pointer"
              >
                {viewMode === "grid" ? (
                  <>

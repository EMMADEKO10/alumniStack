...
const stories = [
  {
    ...
    description:
     "Après avoir obtenu son diplôme en ingénierie informatique au Université de Kinshasa (Unikin), Jean Kazunga a fondé sa propre start-up technologique. Grâce aux compétences et aux connaissances acquises pendant ses études, il a réussi à développer une entreprise prospère qui révolutionne l'industrie de la technologie.",
    date: "5 mars 2023",
  ...
  },
  {
    ...
    description:
      "Olga Mujinga, diplômée en administration des affaires du Université de Kinshasa (Unikin), a surmonté de nombreux obstacles pour atteindre le succès. Malgré des débuts modestes, elle a utilisé les compétences en leadership et en gestion qu'elle a acquises à l'université pour gravir les échelons et devenir PDG d'une grande entreprise internationale.",
    date: "12 Avril 2023",
    image: "/graduation.jpg",
    category: "Leadership",
    featured: true,
  ...
  },
  {
    ...
    description:
      "Après avoir obtenu son diplôme en commerce international au Université de Kinshasa (Unikin), David Muyumba a poursuivi une carrière internationale passionnante. Il a travaillé dans différentes entreprises multinationales, parcourant le monde et établissant des partenariats commerciaux fructueux dans divers pays.",
  ...
  },
  {
    ...
    description:
      "Le Dr. Paul Kabila a poursuivi sa passion pour la recherche médicale après avoir étudié au Université de Kinshasa (Unikin). Ses découvertes révolutionnaires dans le traitement des maladies tropicales ont été publiées dans les plus prestigieuses revues scientifiques mondiales.",
          ...
          <div className="text-center">
            ...
            >
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-lg font-semibold">Unikin Alumni</span>
              </div>
            </motion.div>
          </div>
        </div>

...
import { Community, CommunityType, LEGACY_FACULTIES, REGIONS, PROFESSIONAL_SECTORS } from '../../../types/community';
...
function validateCommunityData(type: CommunityType, data: CommunityData): string | null {
  switch (type) {
    ...
    case CommunityType.FACULTY:
      ...
      const faculty = LEGACY_FACULTIES.find(f => f.id === data.facultyId);
      if (!faculty) {

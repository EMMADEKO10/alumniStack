        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          >
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-red-50 text-red-700 rounded-full w-fit border border-red-100 uppercase tracking-widest text-[10px] sm:text-xs font-bold">
                <FaUniversity />
              ...
              <p className="text-sm sm:text-lg lg:text-xl text-slate-600 leading-relaxed font-medium">
              ...
              <div className="p-5 sm:p-6 bg-slate-50 rounded-2xl border-l-4 border-red-600 italic text-slate-700 relative">
                <FaQuoteLeft className="absolute top-4 right-4 text-slate-200 text-3xl sm:text-4xl -z-10" />
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="/about"
                className="inline-flex items-center gap-3 px-6 py-3.5 sm:px-8 sm:py-4 bg-red-600 text-white rounded-xl font-bold text-sm sm:text-base hover:bg-red-700 transition-all duration-300 shadow-xl hover:shadow-red-500/20 group active:scale-95"
              >
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <div className="relative h-87.5 sm:h-125 lg:h-150 w-full rounded-2xl overflow-hidden shadow-2xl">
              <Image
                src="/graduation.jpg"
                alt="Graduation LAU"
                fill

                  ...
                  <div className="space-y-6 text-gray-700 leading-relaxed">
                    {story.fullContent ? (
                      ...
                      <>
                        ...
                        <p className="text-lg">
                          Comme beaucoup d&apos;alumni de Legacy University, {story.author} a dû faire face à de nombreux défis. 
                        ...
                        <blockquote className="border-l-4 border-blue-500 pl-6 italic text-xl text-blue-800 bg-blue-50 p-4 rounded-r-lg">
                          &quot;N&apos;ayez pas peur de rêver grand. Legacy University vous donne les outils, 

      ...
      <div className="pt-32 sm:pt-40 lg:pt-48">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 relative z-10">
          ...
          <motion.div
            ...
            className="bg-white/80 backdrop-blur-sm rounded-xl shadow-sm p-4 sm:p-6 mb-8 border border-gray-200"
          >
            <div className="flex flex-col lg:flex-row gap-3 sm:gap-4 items-center">
              ...
              <div className="relative flex-1 w-full lg:max-w-md">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 sm:py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-600 focus:border-red-600 transition-all duration-200 text-sm sm:text-base"
                />
              </div>
              ...
              <div className="flex items-center gap-2 sm:gap-4 w-full lg:w-auto">
                <button
                  ...
                  className={`flex-1 lg:flex-none flex items-center justify-center gap-2 px-4 py-2.5 sm:py-3 rounded-xl font-medium transition-all duration-200 text-sm sm:text-base ${
                ...
                >
                  ...
                  {activeFiltersCount > 0 && (
                    <span className="ml-1 bg-white text-red-600 rounded-full w-4 h-4 sm:w-5 sm:h-5 flex items-center justify-center text-[10px] sm:text-xs font-bold shrink-0">
                      {activeFiltersCount}
                    </span>
                  )}
                </button>
                ...
                <div className="flex items-center gap-2 flex-1 lg:flex-none">
                  ...
                  <select
                    ...
                    className="w-full lg:w-auto px-3 py-2 sm:py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-600 focus:border-red-600 transition-all text-xs sm:text-sm bg-white"
                  >
        ...
        {filteredAlumni.length === 0 ? (
            ...
            {/* Grille de fonctionnalités - Palette LAU (Déplacée en bas) */}
            <motion.div 
              className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mt-16 pb-8"
              initial={{ opacity: 0, y: 30 }}
